...
streamlines = []
for k, sy in enumerate([166, 180, 264, 278]):
    streamlines.append(
...
{row(CYL_Y + ROW_DY, -1, "#f0a020", A / 2)}
  ...
  <text x="{W/2}" y="86" text-anchor="middle" fill="url(#nameGrad)"
        font-family="Segoe UI, Helvetica Neue, Helvetica, Arial, sans-serif"
        font-size="54" font-weight="700" letter-spacing="1">Suvam Samanta</text>
  <text x="{W/2}" y="122" text-anchor="middle" fill="#8b98a9"
        font-family="SFMono-Regular, Menlo, Consolas, monospace"
        font-size="16" letter-spacing="4">making fluids misbehave, on purpose</text>
  <text x="{W/2}" y="311" text-anchor="middle" fill="#6b7a8d"
        font-family="SFMono-Regular, Menlo, Consolas, monospace" font-size="12.5"
        letter-spacing="2.2" opacity="0.85">Re &#8776; 150 &#183; St &#8776; 0.18 &#183; still shedding</text>
</svg>
"""

with open("/home/syphonic/WORK/Syphonicc/assets/header.svg", "w") as f:
    f.write(svg)
print("wrote header.svg v2", len(svg), "bytes")
