#!/usr/bin/env python3
"""Generate an animated von Karman vortex street banner for the profile README.
...
streamlines = []
for k, sy in enumerate([54, 86, 210, 242]):
    streamlines.append(
        f'  <path d="M-40 {sy} L{W + 40} {sy}" stroke="#64748b" stroke-width="1.4" '
        f'fill="none" opacity="0.30" stroke-dasharray="26 34" stroke-linecap="round">'
...
{row(CYL_Y + ROW_DY, -1, "#fbbf24", A / 2)}
  ...
  <text x="{W/2}" y="112" text-anchor="middle" fill="url(#nameGrad)"
        font-family="Segoe UI, Helvetica Neue, Helvetica, Arial, sans-serif"
        font-size="60" font-weight="700" letter-spacing="1">Suvam Samanta</text>
  <text x="{W/2}" y="150" text-anchor="middle" fill="#94a3b8"
        font-family="SFMono-Regular, Menlo, Consolas, monospace"
        font-size="17" letter-spacing="4.5">making fluids misbehave, on purpose</text>
  <text x="{W/2}" y="196" text-anchor="middle" fill="#64748b"
        font-family="SFMono-Regular, Menlo, Consolas, monospace" font-size="13.5"
        letter-spacing="2.2" opacity="0.9">Re &#8776; 150 &#183; St &#8776; 0.18 &#183; still shedding</text>
</svg>
"""

with open("/home/syphonic/WORK/Syphonicc/assets/header.svg", "w") as f:
    f.write(svg)
print("wrote header.svg", len(svg), "bytes")
